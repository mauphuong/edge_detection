...
class EdgeDetector {
  ...
  Future<void> processImageIsolate(ProcessImageInput processImageInput) async {
    processImage(processImageInput.inputPath, processImageInput.edgeDetectionResult);
